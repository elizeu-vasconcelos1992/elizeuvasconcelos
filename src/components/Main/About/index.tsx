    ...
    <StyledAbout>
      ...
      <div className="about-text">
        ...
        <p>
          ...
          Amapá. Sou músico por natureza, engenheiro/pesquisador por curiosidade
          e desenvolvedor por paixão.
        </p>
        <p>
        ...
        <p>
          Possuo experiência e facilidade com o trabalho em equipe, metodologias
          ágeis, como SMART, SCRUM e KANBAN, engenharia e desenvolvimento
          front-end com React.JS. Busco me aperfeiçoar diariamente e a
          curiosidade e persistência são meus principais combustíveis.
        </p>
      </div>
    </StyledAbout>
  );
